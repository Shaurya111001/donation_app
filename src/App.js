...
import { connectWallet, setup } from "./library/connection";
import { getValue, setAll, addDonation } from "./library/modules";
            ...
            <Navbar.Brand>
              ...
              <Navbar.Collapse className="right_navbar">
                <Nav>
                  ...
                  <Nav.Link onClick={LoginOpen}>Start a Fundraiser</Nav.Link>
        ...
        <div class="row">
          ...
          <div class="col-xs-6 col-md-3">
            ...
            <ul class="footer-links">
              ...
              <li><a href="https://www.linkedin.com/in/archit-porwal">LinkedIN</a></li>
            </ul>
          </div>
        </div>
      </div>
